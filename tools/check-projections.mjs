...
const files = [
  'public/projections/ergonx-rn013.v1.json',
  'public/projections/quickstart-benefit-eligibility.v1.json',
  'public/projections/quickstart-payroll-reactive-determinations.v1.json'
];
